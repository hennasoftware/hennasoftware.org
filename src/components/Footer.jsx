  ...
  return (
    <>
      <footer className={'pt-20 pb-5'}>
        <div
          className={
            'container max-w-7xl mx-auto px-4 flex flex-col gap-4 sm:px-6 lg:px-8'
          }
        >
          <div
            className={
              'flex flex-col gap-8 text-lg lg:flex-row lg:justify-between lg:items-center'
            }
          >
            <div>
              <h3 className={'font-medium italic text-italic text-2xl'}>
                Henna Software{' '}
              </h3>
          ...
          <div
            className={
              'flex flex-col justify-center items-center text-center text-slate-600 sm:flex-row'
            }
          >

          ...
          <div className={'flex flex-col gap-16 text-center max-w-2xl md:text-left lg:max-w-3xl'}>
            ...
            <div
              ...
              <a href={'https://github.com/hennasoftware'} target={'_blank'}
                 className={'w-full max-w-2xs text-xl px-4 py-2 bg-blue-500 rounded-sm transition-all hover:bg-blue-400 md:mx-0 sm:w-2xs md:w-fit'}>
                <i className="uil uil-github"></i> Explore our Projects
              </a>

              <a href={'https://discord.gg/ZfFnhhHDhK'} target={'_blank'}
                 className={'w-full max-w-2xs text-xl px-4 py-2 bg-transparent border border-blue-500 rounded-sm transition-all hover:bg-blue-950 md:mx-0 sm:w-2xs md:w-fit'}>

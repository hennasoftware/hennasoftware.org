        ...
        <div className={'container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'}>
          <div className={'space-y-8'}>
            ...
            <p className={'text-slate-500 text-base sm:text-xl'}>
              From a Discord community of friends to a passionate development
              collective, we're on a mission to learn, grow, and create
          ...
          <div className={'pt-20 flex flex-col gap-6 md:flex-row'}>
            <StoryCard
              ...
              title={'The Beginning'}
              description={
                'Connected through our shared passion for coding and technology on Discord'
              }
            />
            ...
            <StoryCard
              ...
              description={
                'Building a supportive community where every member contributes to collective growth.'
              }
            />

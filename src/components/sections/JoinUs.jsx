    ...
    <>
      <section id={'contact'} className={'py-20 text-center bg-slate-900'}>
        <div className={'container max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8'}>
          ...
          <p className={'text-slate-500 text-base sm:text-2xl'}>We may currently be a close-knit group of friends, but
          ...
          <div className={'mt-20'}>
            <a href={'https://discord.gg/ZfFnhhHDhK'} target={'_blank'}
               className={'w-full max-w-2xs text-xl px-8 py-4 bg-blue-500 rounded-sm transition-all hover:bg-blue-400 sm:w-fit sm:text-2xl'}>

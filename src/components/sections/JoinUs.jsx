  ...
  return (
    <>
      <section id={'join'} className={'py-20 text-center bg-slate-900'}>
        <div
          className={
            'container max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8'
          }
        >
          <h3 className={'text-3xl sm:text-4xl'}>Want to Collaborate?</h3>

          <p className={'text-slate-500 text-base sm:text-xl'}>
            We may currently be a close-knit group of friends, but we're always
            excited to welcome passionate and like-minded individuals from all
            corners of the world to collaborate on impactful projects. If you
            share our enthusiasm for learning, growth, and making a difference,
